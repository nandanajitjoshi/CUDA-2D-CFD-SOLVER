...
* @param low, high, diag: Vectors for the diagonals
* @param rows: is the total number of vertices - Ny*Nx
* @param mu,rho Viscosity and Density
* @param delT : Size of timestep
* @param varId : Variable being solved 'U' = Vel along X , 'V' : along Y
*/
__global__
                ...
                switch (thisV.BSide){
                    ...
                    /*Left-Side Boundary*/
                        if ((thisV.BType == '0') || (thisV.BType == '2')) {
                            /*Inlet or Wall*/
                            /*The value of velocity is fixed. So the TDM coeffs are simple [0,1,0]*/
                            low [thread_idx] =  0;
                            high [thread_idx] =  0;
                            diag [thread_idx] =  1 ;
...
/*Generates  tridiag coeffieicnts along Y and transposes col-based to row-based
* @param low,high,diag : Lower, Upper and Main diags of tridiag matrix
* @param mu,rho : Viscosity and density
* @param rows : Total no of grid points
* @param delT : Timerstep
* @param varId : Variable under consideration, 'U' or 'V'
*/
